...
def show_about_page():
    ...
    st.write('* After crossing information using a pivot table, the number of observations reduced to 3,229, which is the Dataset I will be using for my modeling.')
    st.write('* Most important feature to calculate budget was the number of paid leads with 0.88 Pearson Correlation Score.')
    st.write('* 9 regression models were used for this project being Gradient Booster the model with best performance on test data with 0.86 R2 score, which is the model that I used in the predict page.')
